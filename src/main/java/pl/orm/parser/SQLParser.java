...
//                }
//                Annotation firstOne = oneParameterAnnos[0];
//                if (firstOne instanceof Bind) {
...
//                } else if (firstOne instanceof BindMap) {
//                    //map的话需要传值之后才知道有哪些属性,需要在调用的时候动态生成
//                    sb.append("");
//                } else {
//                    throw new IllegalArgumentException("暂时不支持其他注解:" + oneParameterAnnos[0]);
//
//                }
//            }
//            return sb.toString();
